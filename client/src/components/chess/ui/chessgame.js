...
const ChessGameWrapper = (props) => {
    ...
    return (
        ...
        {opponentDidJoinTheGame ? (
          ...
          <div class="container">
            <h4 className="chess-expired" style={{ textAlign: "center", marginTop: "100px",marginBottom:'50px'}}> Sorry!! Session expired  :( </h4>
          </div>
        ) : (
          <div className="container ">
              <div className="text-center chess-copy">
            <h4 className="chess-heading"
              style={{
                textAlign: "center",
            ...
            <h4 style={{ textAlign: "center", marginTop: "100px",marginBottom:'50px'}} className="chess-heading"> 
              {" "}
